...
function makeSky() {
  ...
  var object = new THREE.Object3D(); // define the object as a 3D object
  object.name ="sky"; // name teh object so we can identfy it
...
//   // var light = new THREE.DirectionalLight( 0x00b386, 0.3 );
...
//
//   var skyUniforms = {
//     topColor: 	 { type: "c", value: new THREE.Color(0xffff00 ) },
//     bottomColor: { type: "c", value: new THREE.Color( 0xffff00) },
